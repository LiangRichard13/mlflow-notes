...
2. Map to the appropriate skill:
   ...
   - Classical ML lifecycle (tracking / registry / evaluate / serve / monitor / tuning) → `classical-ml`
...
- **If the user says "evaluate my sklearn/xgboost/pytorch model" or "monitor/deploy/track my classical model", route to `classical-ml`** — `agent-evaluation` is for GenAI agents only.
