...
### Classical ML Lifecycle

| Skill | Description |
|-------|-------------|
| **classical-ml** | Guides the full classical ML model lifecycle — tracking with autolog, registry aliases (champion/challenger), mlflow.models.evaluate with threshold gates, serve/containers/batch, dataset lineage + system metrics, and hyperparameter optimization with Optuna/GridSearchCV. |
